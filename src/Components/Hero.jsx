  ...
  return (
   <section className='min-h-screen flex flex-col justify-start items-center p-5 text-center'>
    ...
    <div>
        ...
        <a href="/kiran hp.pdf" download={true} className='flex items-center justify-center mt-10 bg-gradient-to-r from-yellow-300 to-pink-500 text-white py-2 rounded-lg'>
            Resume
        </a>
    </div>
